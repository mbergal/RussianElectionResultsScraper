            ...
            public static class @base {
                ...
                public static class images {
                    ...
                    public static class tooltip {
                        private const string URLPATH = "~/Content/themes/base/images/tooltip";
                        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                        public static readonly string black_png = Url("black.png");
                        public static readonly string black_arrow_png = Url("black_arrow.png");
                        public static readonly string black_arrow_big_png = Url("black_arrow_big.png");
                        public static readonly string black_big_png = Url("black_big.png");
                        public static readonly string white_png = Url("white.png");
                        public static readonly string white_arrow_png = Url("white_arrow.png");
                        public static readonly string white_arrow_big_png = Url("white_arrow_big.png");
                        public static readonly string white_big_png = Url("white_big.png");
                    }
